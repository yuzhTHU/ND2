...
def main(args):
    ...
    # print(rewarder.solve(['add', 'omega', 'aggr', 'sin', 'sub', 'sour', 'x', 'targ', 'x']))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--name', type=str, default=f'SearchHiddenWeight_{time.strftime("%Y%m%d_%H%M%S")}')
    parser.add_argument('-d', '--device', type=str, default='auto')
    parser.add_argument('-s', '--seed', type=int, default=None)
    parser.add_argument('--data', type=str, default='./data/hetero_edge/hetero_edge_kuramoto.json')
